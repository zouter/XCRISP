...
case "$1" in
    "transfer")
        ...
        if [[ "$2" == *hpc* ]]; then
            ...
            containers/lab.sif \
            /home/dsbpredict/miniconda3/envs/X-CRISP/bin/python3 -m src.models.X-CRISP.transfer $3 $4 $5 $6 
        else
            ...
            -B $OUTPUT_DIR:$OUTPUT_DIR \
            containers/lab.sif \
            /home/dsbpredict/miniconda3/envs/X-CRISP/bin/python3 -m src.models.X-CRISP.transfer pretrained 5 HAP1_train HAP1
        fi
        ;;
    "test_transfer")
        ...
        if [[ "$2" == *hpc* ]]; then
            ...
            -B $OUTPUT_DIR:$OUTPUT_DIR \
            containers/lab.sif \
            /home/dsbpredict/miniconda3/envs/X-CRISP/bin/python3 -m src.models.X-CRISP.test_transfer $3 $4 
        else
            echo "Environment variable does not contain 'hpc'"
            apptainer exec -C \
            -H $PROTONDDR/repos/x-crisp/ \
            ...
            -B $OUTPUT_DIR:$OUTPUT_DIR \
            containers/lab.sif \
            /home/dsbpredict/miniconda3/envs/X-CRISP/bin/python3 -m src.models.X-CRISP.test_transfer pretrained 5 
        fi
        ;;
    *)
