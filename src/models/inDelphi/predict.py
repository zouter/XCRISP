...
from model import nn_match_score_function
...
def featurize(seq, cutsite, DELLEN_LIMIT = 29):
...
def predict_dels(seq, cutsite):
  ...
  return total_phi_score, dlpred

##
# Prediction
##
# mh_len, gc_frac, del_len, gt_pos,
...
# Init
##
def init_model(run_iter = '', param_iter = 'ado'):
  # run_iter = 'aav'
  # param_iter = 'aag'
  # run_iter = 'aaw'
  # param_iter = 'aae'
