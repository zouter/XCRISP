# mpiexec -n 3 /Users/colm/anaconda3/envs/X-CRISP/bin/python interpretability.py test no_hdr mh
...
from model_kld import load_model, load_data, NeuralNetwork, MH_LESS_FEATURES, MH_FEATURES, _to_tensor
...
if __name__ == "__main__":
    ...
    features = MH_LESS_FEATURES + MH_FEATURES
    ...
    if rank == 0:
        data = pd.concat(data)
        data.to_csv(output_dir + "model_kld_{}.{}.shap.tsv".format(test_genotype, mh_or_mhless), sep="\t")
    else:
        assert data is None
